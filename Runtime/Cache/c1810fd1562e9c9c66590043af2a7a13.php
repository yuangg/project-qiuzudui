    ...
    <!-- navigation-bar -->
      <div class="navbar">
        <div class="container-fluid">
          <!--brand-->
          <a class="brand" href="home_afterlogin_public.html">
            <img src="Public/images/logo.jpg" class="img-responsive" alt="Responsive image">
          </a>
          <!--register & login-->
          <div class="first-approch pull-right afterLogin">
            <a href="7association_info.html"><img id="photo-public" src="Public/images/photoPublic.png"></a>
          </div>
          <div class="first-approch pull-right afterLogin left">
            <div id="publicName"><a href="7association_info.html">
              <img src="Public/images/team.png">
              <span id="name">软件学院学生会</span></a>
            </div>
            <div class="bottom">
              <div class="bottom1" id="public-info"><a href="__APP__/Profile"><img src="Public/images/info.png">社团信息</a></div>
        ...
        <div class="navline">
          ...
          <span class="home"><a id="home" href="home_afterlogin_public.html">首页</a>|</span>
          <span class="home"><a id="home" href="MyCompetitionList.html">我的比赛</a>|</span>
          <span class="home"><a id="home" href="postCompetition.html">发布比赛</a>|</span>
      ...
      <form id="infoForm" action="#" method="post">
        <div class="info-block">
          ...
          <div class="photo">
            ...
            <input type="file" id="upload" class="form-control info-value" style="display:none">
        ...
        <div class="info-block">
          ...
          <textarea cols="100" name="intro" rows="5" type="text" id="intro" class="info-value" placeholder="不要超过2000字哦" maxlength="2000"></textarea>
        </div>
