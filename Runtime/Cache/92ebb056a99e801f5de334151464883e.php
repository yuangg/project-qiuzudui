        ...
        <?php if(is_array($activitys)): foreach($activitys as $key=>$row): ?><div class="row result">
            <?php if(is_array($row)): foreach($row as $key=>$ac): ?><div class="span6">
              ...
              <div class="detail">
                ...
                <div class="aboutTeam">
                  <span class="findTeam" ac_id = <?php echo ($ac["id"]); ?>><a><img ac_id = <?php echo ($ac["id"]); ?> class = "qiuzudui" onclick="handler($(this))" src="../Public/images/findTeam.png"></a></span>
                </div>
              </div>
