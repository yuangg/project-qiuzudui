      ...
      <div class="navbar">
        <div class="container-fluid">
          ...
          <div class="first-approch pull-right afterLogin">
            <a href="individual_info.html"><img id="photo-private" src="Public/images/photoPrivate.png"></a>
          </div>
          <div class="first-approch pull-right afterLogin left">
            <div id="privateName"><a href="individual_info.html">
              <img src="Public/images/private.png">
              <span id="name">王栩瑶</span></a>
            </div>
            <div class="bottom">
              <div class="bottom1" id="private-info"><a href="individual_info.html"><img src="Public/images/info.png">个人信息</a></div>
              <div class="bottom1" id="logout"><a href="home.html"><img src="Public/images/logout.png">退出</a></div>
            </div>
          </div>
        </div>
        <div class="navline">
          ...
          <span class="home"><a id="home" href="">首页</a>&nbsp;|&nbsp;</span>
